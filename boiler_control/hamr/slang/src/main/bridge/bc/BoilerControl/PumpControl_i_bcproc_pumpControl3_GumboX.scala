...
object PumpControl_i_bcproc_pumpControl3_GumboX {
  ...
  /** IEP-Guar: Initialize Entrypoint Contracts for pumpControl3
    *
    * @param isPumpFlow post-state state variable
    * @param isPumpOpen post-state state variable
    * @param pumpNumber post-state state variable
  ...
  @strictpure def inititialize_IEP_Post (
      ...
      api_pumpFlow: Option[Base_Types.Boolean],
      api_pumpOpen: Option[Base_Types.Boolean]): B =
    (// IEP-Guar: Initialize Entrypoint contract for pumpControl3
  ...
  /** IEP-Post: Initialize Entrypoint Post-Condition via container
    ...
    */
  @strictpure def inititialize_IEP_Post_Container (post: PumpControl_i_bcproc_pumpControl3_PostState_Container_PS): B =
  ...
  /** CEP-T-Case: Top-Level case contracts for pumpControl3's compute entrypoint
    *
    * @param In_isPumpOpen pre-state state variable
    * @param isPumpFlow post-state state variable
    * @param isPumpOpen post-state state variable
  ...
  /** CEP-Post: Compute Entrypoint Post-Condition for pumpControl3
    *
  ...
  @strictpure def compute_CEP_Post (
      ...
      api_pumpFlow: Option[Base_Types.Boolean],
      api_pumpOpen: Option[Base_Types.Boolean]): B =
    (// CEP-T-Case: case clauses of pumpControl3's compute entrypoint
     compute_CEP_T_Case (In_isPumpOpen, isPumpFlow, isPumpOpen, api_programReady, api_openPump, api_ready, api_pumpFlow, api_pumpOpen))

  /** CEP-Post: Compute Entrypoint Post-Condition for pumpControl3 via containers
    *
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: PumpControl_i_bcproc_pumpControl3_PreState_Container_PS,
      post: PumpControl_i_bcproc_pumpControl3_PostState_Container_PS): B =
    compute_CEP_Post(
