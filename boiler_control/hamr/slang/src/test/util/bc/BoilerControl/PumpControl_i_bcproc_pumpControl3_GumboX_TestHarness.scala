...
@msig trait PumpControl_i_bcproc_pumpControl3_GumboX_TestHarness extends PumpControl_i_bcproc_pumpControl3_TestApi {
  def verbose: B
  ...
  def testInitialiseCB(
    ...
    val isPumpOpen: Base_Types.Boolean = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpOpen
    val isPumpFlow: Base_Types.Boolean = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpFlow
    val pumpNumber: Base_Types.Integer = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.pumpNumber
    ...
    val postResult = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3_GumboX.inititialize_IEP_Post(isPumpFlow, isPumpOpen, pumpNumber, api_ready, api_pumpFlow, api_pumpOpen)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    bc.JSON.toBoilerControlPumpControl_i_bcproc_pumpControl3_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: PumpControl_i_bcproc_pumpControl3_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
    ...
    val In_isPumpOpen: Base_Types.Boolean = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpOpen
    val In_isPumpFlow: Base_Types.Boolean = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpFlow
    val In_pumpNumber: Base_Types.Integer = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.pumpNumber

    // [CheckPre]: check/filter based on pre-condition.
    //   pumpControl3's compute entry point does not have top level assume clauses
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = bc.BoilerControl.PumpControl_i_bcproc_pumpControl3_GumboX.compute_CEP_Post(In_isPumpFlow, In_isPumpOpen, In_pumpNumber, isPumpFlow, isPumpOpen, pumpNumber, api_programReady, api_openPump, api_ready, api_pumpFlow, api_pumpOpen)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    bc.JSON.toBoilerControlPumpControl_i_bcproc_pumpControl3_PreState_Container_PS(json) match {
      case Either.Left(o) => return testComputeCBwLV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBwLV(o: PumpControl_i_bcproc_pumpControl3_PreState_Container_PS): GumboXResult.Type = {
  ...
  def testComputeCBwL(
    ...
    bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpOpen = In_isPumpOpen
    bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.isPumpFlow = In_isPumpFlow
    bc.BoilerControl.PumpControl_i_bcproc_pumpControl3.pumpNumber = In_pumpNumber
