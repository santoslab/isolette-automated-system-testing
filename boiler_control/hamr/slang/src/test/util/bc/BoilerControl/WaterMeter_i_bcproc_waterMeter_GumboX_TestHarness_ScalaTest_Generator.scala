...
object WaterMeter_i_bcproc_waterMeter_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"WaterMeter_i_bcproc_waterMeter_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import WaterMeter_i_bcproc_waterMeter_GumboX_TestHarness_ScalaTest_Generator._

trait WaterMeter_i_bcproc_waterMeter_GumboX_TestHarness_ScalaTest_Generator extends WaterMeter_i_bcproc_waterMeter_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[WaterMeter_i_bcproc_waterMeter_Profile]

  def getDefaultInitialiseProfile: WaterMeter_i_bcproc_waterMeter_Profile = {
    return WaterMeter_i_bcproc_waterMeter_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[WaterMeter_i_bcproc_waterMeter_Profile_P]

  def getDefaultProfile_P: WaterMeter_i_bcproc_waterMeter_Profile_P = {
    return WaterMeter_i_bcproc_waterMeter_Profile_P (
  ...
  def getProfiles_PS: MSZ[WaterMeter_i_bcproc_waterMeter_Profile_PS]

  def getDefaultProfile_PS: WaterMeter_i_bcproc_waterMeter_Profile_PS = {
    return WaterMeter_i_bcproc_waterMeter_Profile_PS (
  ...
  def next(profile: WaterMeter_i_bcproc_waterMeter_Profile_P): Option[WaterMeter_i_bcproc_waterMeter_PreState_Container_P] = {
    try {
      ...
      return Some(WaterMeter_i_bcproc_waterMeter_PreState_Container_P(api_programReady,api_opMode))
    } catch {
  ...
  def nextwL(profile: WaterMeter_i_bcproc_waterMeter_Profile_PS): Option[WaterMeter_i_bcproc_waterMeter_PreState_Container_PS] = {
    try {
      val In_volume = profile.In_volume.nextF32()
      val api_programReady = profile.api_programReady.nextOption_artEmpty()
      val api_opMode = profile.api_opMode.nextOptionBoilerControlOpModeType()

      return Some(WaterMeter_i_bcproc_waterMeter_PreState_Container_PS(In_volume,api_programReady,api_opMode))
    } catch {
      case e: AssertionError =>
       // SlangCheck was unable to satisfy a datatype's filter
       return None()
  ...
  def testInitialiseCB_Profile(profile: WaterMeter_i_bcproc_waterMeter_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: WaterMeter_i_bcproc_waterMeter_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlWaterMeter_i_bcproc_waterMeter_PreState_Container_P(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            ...
                            |    val testVector = bc.JSON.toBoilerControlWaterMeter_i_bcproc_waterMeter_PreState_Container_P(json).left
  ...
  def testComputeCBwL_Profile_PS(profile: WaterMeter_i_bcproc_waterMeter_Profile_PS): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          nextwL(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlWaterMeter_i_bcproc_waterMeter_PreState_Container_PS(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            |  test("Replay: $escapedTestName") {
                            |    val json = st${tq}${json}${tq}.render
                            |    val testVector = bc.JSON.toBoilerControlWaterMeter_i_bcproc_waterMeter_PreState_Container_PS(json).left
