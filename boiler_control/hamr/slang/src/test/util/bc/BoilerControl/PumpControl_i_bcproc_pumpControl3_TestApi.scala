...
@msig trait PumpControl_i_bcproc_pumpControl3_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3)
  }
  ...
  /** helper function to check PumpControl_i_bcproc_pumpControl3's
  ...
  def put_opMode(value : BoilerControl.OpMode.Type): Unit = {
    Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.opMode_Id, BoilerControl.OpMode_Payload(value))
  }

  // setter for in EventDataPort
  def put_openPump(value : Base_Types.Boolean): Unit = {
    Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.openPump_Id, Base_Types.Boolean_Payload(value))
  }

  // setter for in EventPort
  def put_programReady(): Unit = {
    Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.programReady_Id, art.Empty())
  }
  ...
  def get_pumpOpen_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.initialization_api.pumpOpen_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }
  ...
  def get_pumpFlow_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.initialization_api.pumpFlow_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }
  ...
  def get_ready_payload(): Option[art.Empty] = {
    return Art.observeOutInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.initialization_api.ready_Id).asInstanceOf[Option[art.Empty]]
  }
