...
object PumpControl_i_bcproc_pumpControl1_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"PumpControl_i_bcproc_pumpControl1_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import PumpControl_i_bcproc_pumpControl1_GumboX_TestHarness_ScalaTest_Generator._

trait PumpControl_i_bcproc_pumpControl1_GumboX_TestHarness_ScalaTest_Generator extends PumpControl_i_bcproc_pumpControl1_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[PumpControl_i_bcproc_pumpControl1_Profile]

  def getDefaultInitialiseProfile: PumpControl_i_bcproc_pumpControl1_Profile = {
    return PumpControl_i_bcproc_pumpControl1_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[PumpControl_i_bcproc_pumpControl1_Profile_P]

  def getDefaultProfile_P: PumpControl_i_bcproc_pumpControl1_Profile_P = {
    return PumpControl_i_bcproc_pumpControl1_Profile_P (
  ...
  def getProfiles_PS: MSZ[PumpControl_i_bcproc_pumpControl1_Profile_PS]

  def getDefaultProfile_PS: PumpControl_i_bcproc_pumpControl1_Profile_PS = {
    return PumpControl_i_bcproc_pumpControl1_Profile_PS (
  ...
  def next(profile: PumpControl_i_bcproc_pumpControl1_Profile_P): Option[PumpControl_i_bcproc_pumpControl1_PreState_Container_P] = {
    try {
      ...
      return Some(PumpControl_i_bcproc_pumpControl1_PreState_Container_P(api_programReady,api_opMode,api_openPump))
    } catch {
  ...
  def nextwL(profile: PumpControl_i_bcproc_pumpControl1_Profile_PS): Option[PumpControl_i_bcproc_pumpControl1_PreState_Container_PS] = {
    try {
      ...
      return Some(PumpControl_i_bcproc_pumpControl1_PreState_Container_PS(In_isPumpFlow,In_isPumpOpen,In_pumpNumber,api_programReady,api_opMode,api_openPump))
    } catch {
      case e: AssertionError =>
       // SlangCheck was unable to satisfy a datatype's filter
       return None()
  ...
  def testInitialiseCB_Profile(profile: PumpControl_i_bcproc_pumpControl1_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: PumpControl_i_bcproc_pumpControl1_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlPumpControl_i_bcproc_pumpControl1_PreState_Container_P(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            ...
                            |    val testVector = bc.JSON.toBoilerControlPumpControl_i_bcproc_pumpControl1_PreState_Container_P(json).left
  ...
  def testComputeCBwL_Profile_PS(profile: PumpControl_i_bcproc_pumpControl1_Profile_PS): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          nextwL(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlPumpControl_i_bcproc_pumpControl1_PreState_Container_PS(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            |  test("Replay: $escapedTestName") {
                            |    val json = st${tq}${json}${tq}.render
                            |    val testVector = bc.JSON.toBoilerControlPumpControl_i_bcproc_pumpControl1_PreState_Container_PS(json).left
