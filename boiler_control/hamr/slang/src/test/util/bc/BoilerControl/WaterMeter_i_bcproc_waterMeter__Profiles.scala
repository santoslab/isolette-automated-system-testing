...
@record class WaterMeter_i_bcproc_waterMeter_Profile (
  val name: String,
  val numTests: Z //number of tests to generate
)

// Profile with generators for incoming ports
@record class WaterMeter_i_bcproc_waterMeter_Profile_P(
  val name: String,
  val numTests: Z, // number of tests to generate
...
@record class WaterMeter_i_bcproc_waterMeter_Profile_PS(
  val name: String,
  val numTests: Z, // number of tests to generate
  var numTestVectorGenRetries: Z, // number of test vector generation retries
