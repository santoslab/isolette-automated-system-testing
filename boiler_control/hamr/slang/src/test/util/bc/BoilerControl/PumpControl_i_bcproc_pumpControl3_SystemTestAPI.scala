...
object PumpControl_i_bcproc_pumpControl3_SystemTestAPI {
  ...
  def put_In_isPumpFlow(value: Base_Types.Boolean): Unit = {
    PumpControl_i_bcproc_pumpControl3.isPumpFlow = value
  }

  // setter for state variable
  def put_In_isPumpOpen(value: Base_Types.Boolean): Unit = {
    PumpControl_i_bcproc_pumpControl3.isPumpOpen = value
  }

  // setter for state variable
  def put_In_pumpNumber(value: Base_Types.Integer): Unit = {
    PumpControl_i_bcproc_pumpControl3.pumpNumber = value
  }

  // setter for incoming event  port
  def put_programReady(value: Option[art.Empty]): Unit = {
    value match {
      case Some(v) => Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.programReady_Id, v)
      case _ =>
    }
  }
  ...
  def put_opMode(value: Option[BoilerControl.OpMode.Type]): Unit = {
    value match {
      case Some(v) => Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.opMode_Id, BoilerControl.OpMode_Payload(v))
      case _ =>
    }
  }
  ...
  def put_openPump(value: Option[Base_Types.Boolean]): Unit = {
    value match {
      case Some(v) => Art.insertInInfrastructurePort(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.operational_api.openPump_Id, Base_Types.Boolean_Payload(v))
      case _ =>
    }
  }

  def fetchContainer(): bc.BoilerControl.PumpControl_i_bcproc_pumpControl3_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.id)) {
      val (_, postContainer_) = runtimeMonitorStream.get(Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.id).get
      return postContainer_.asInstanceOf[bc.BoilerControl.PumpControl_i_bcproc_pumpControl3_PostState_Container_PS]
    }
    else {
      assert(F, s"No post state recorded for ${Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.name}")
      halt(s"No post state recorded for ${Arch.BoilerControlSystem_i_Instance_bcproc_pumpControl3.name}")
    }
  }
  ...
  def get_isPumpFlow(): Base_Types.Boolean = {
    return PumpControl_i_bcproc_pumpControl3.isPumpFlow
  }

  // getter for state variable
  def get_isPumpOpen(): Base_Types.Boolean = {
    return PumpControl_i_bcproc_pumpControl3.isPumpOpen
  }

  // getter for state variable
  def get_pumpNumber(): Base_Types.Integer = {
    return PumpControl_i_bcproc_pumpControl3.pumpNumber
  }
