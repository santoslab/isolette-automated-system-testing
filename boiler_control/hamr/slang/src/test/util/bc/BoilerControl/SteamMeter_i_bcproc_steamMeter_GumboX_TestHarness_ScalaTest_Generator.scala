...
object SteamMeter_i_bcproc_steamMeter_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"SteamMeter_i_bcproc_steamMeter_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import SteamMeter_i_bcproc_steamMeter_GumboX_TestHarness_ScalaTest_Generator._

trait SteamMeter_i_bcproc_steamMeter_GumboX_TestHarness_ScalaTest_Generator extends SteamMeter_i_bcproc_steamMeter_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[SteamMeter_i_bcproc_steamMeter_Profile]

  def getDefaultInitialiseProfile: SteamMeter_i_bcproc_steamMeter_Profile = {
    return SteamMeter_i_bcproc_steamMeter_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[SteamMeter_i_bcproc_steamMeter_Profile_P]

  def getDefaultProfile_P: SteamMeter_i_bcproc_steamMeter_Profile_P = {
    return SteamMeter_i_bcproc_steamMeter_Profile_P (
  ...
  def getProfiles_PS: MSZ[SteamMeter_i_bcproc_steamMeter_Profile_PS]

  def getDefaultProfile_PS: SteamMeter_i_bcproc_steamMeter_Profile_PS = {
    return SteamMeter_i_bcproc_steamMeter_Profile_PS (
      name = "Default Port and State Variable Profile", 
      numTests = 100, 
      numTestVectorGenRetries = 100, 
      In_computedRate = freshRandomLib, 
      In_volume = freshRandomLib, 
      api_programReady = freshRandomLib, 
      api_opMode = freshRandomLib)
  }

  def next(profile: SteamMeter_i_bcproc_steamMeter_Profile_P): Option[SteamMeter_i_bcproc_steamMeter_PreState_Container_P] = {
    try {
      ...
      return Some(SteamMeter_i_bcproc_steamMeter_PreState_Container_P(api_programReady,api_opMode))
    } catch {
  ...
  def nextwL(profile: SteamMeter_i_bcproc_steamMeter_Profile_PS): Option[SteamMeter_i_bcproc_steamMeter_PreState_Container_PS] = {
    try {
      val In_computedRate = profile.In_computedRate.nextF32()
      val In_volume = profile.In_volume.nextF32()
      val api_programReady = profile.api_programReady.nextOption_artEmpty()
      val api_opMode = profile.api_opMode.nextOptionBoilerControlOpModeType()

      return Some(SteamMeter_i_bcproc_steamMeter_PreState_Container_PS(In_computedRate,In_volume,api_programReady,api_opMode))
    } catch {
      case e: AssertionError =>
       // SlangCheck was unable to satisfy a datatype's filter
       return None()
  ...
  def testInitialiseCB_Profile(profile: SteamMeter_i_bcproc_steamMeter_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: SteamMeter_i_bcproc_steamMeter_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlSteamMeter_i_bcproc_steamMeter_PreState_Container_P(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            ...
                            |    val testVector = bc.JSON.toBoilerControlSteamMeter_i_bcproc_steamMeter_PreState_Container_P(json).left
  ...
  def testComputeCBwL_Profile_PS(profile: SteamMeter_i_bcproc_steamMeter_Profile_PS): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          nextwL(profile) match {
            case Some(o) =>
              ...
              val json = bc.JSON.fromBoilerControlSteamMeter_i_bcproc_steamMeter_PreState_Container_PS(o, T)
              ...
              if (verbose) {
                ...
                println(st"""Replay Unit Test:
                            |  test("Replay: $escapedTestName") {
                            |    val json = st${tq}${json}${tq}.render
                            |    val testVector = bc.JSON.toBoilerControlSteamMeter_i_bcproc_steamMeter_PreState_Container_PS(json).left
