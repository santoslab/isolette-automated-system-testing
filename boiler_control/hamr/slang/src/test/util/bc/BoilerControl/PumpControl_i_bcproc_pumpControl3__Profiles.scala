...
@record class PumpControl_i_bcproc_pumpControl3_Profile (
  val name: String,
  val numTests: Z //number of tests to generate
)

// Profile with generators for incoming ports
@record class PumpControl_i_bcproc_pumpControl3_Profile_P(
  val name: String,
  val numTests: Z, // number of tests to generate
...
@record class PumpControl_i_bcproc_pumpControl3_Profile_PS(
  val name: String,
  val numTests: Z, // number of tests to generate
  var numTestVectorGenRetries: Z, // number of test vector generation retries
