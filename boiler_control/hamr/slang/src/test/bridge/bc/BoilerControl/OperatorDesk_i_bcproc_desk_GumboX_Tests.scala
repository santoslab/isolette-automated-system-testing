...
class OperatorDesk_i_bcproc_desk_GumboX_Tests extends OperatorDesk_i_bcproc_desk_GumboX_TestHarness_ScalaTest_Generator {
  ...
  override def getInitialiseProfiles: MSZ[OperatorDesk_i_bcproc_desk_Profile] = {
    return MSZ(getDefaultInitialiseProfile)
  }

  // profiles that will be used to generate the incoming port values
  override def getProfiles_P: MSZ[OperatorDesk_i_bcproc_desk_Profile_P] = {
    return MSZ(getDefaultProfile_P)
  }

  // profiles that will be used to generate the incoming port values
  // and the pre-state values of the state variables
  override def getProfiles_PS: MSZ[OperatorDesk_i_bcproc_desk_Profile_PS] = {
