...
object Monitor_Subsystem_Outputs_Container_SlangCheck {
  ...
  case class SystemTestConfiguration(name: String,
                                     ...
                                     profile: Monitor_Subsystem_Outputs_Container_Profile,
...
trait Monitor_Subsystem_Outputs_Container_SlangCheck
