...
import art.Art
import isolette._
import isolette.system_tests.monitor1.Monitor_Subsystem_Outputs_Container_SlangCheck._
import Example_Monitor_Subsystem_Outputs_Container_Test_wSlangCheck._
import isolette.system_tests.monitor1.Monitor_Subsystem_Outputs_Container_Profile
import isolette.system_tests.monitor1.Monitor_Subsystem_Outputs_Container_Profile._

import scala.language.implicitConversions

// Do not edit this file as it will be overwritten if SystemTestArtifactGen is rerun

class Example_Monitor_Subsystem_Outputs_Container_Test_wSlangCheck
  extends Monitor_Subsystem_Outputs_Container_SlangCheck {
  ...
  def run(config: SystemTestConfiguration): Unit = {
    ...
    def next: Option[Monitor_Subsystem_Outputs_Container] = {
      try {
  ...
  def examplePreStateContainerFilter(container: Monitor_Subsystem_Outputs_Container): B = {
...
object Example_Monitor_Subsystem_Outputs_Container_Test_wSlangCheck {
  ...
  def genJsons(echo: B): B = {
    if (Os.env("JENKINS_HOME").isEmpty) { // don't generate these when CI
      ...
      val inst = new Example_Monitor_Subsystem_Outputs_Container_Test_wSlangCheck()
