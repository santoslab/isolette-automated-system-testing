...
object Example_Regulate_Subsystem_Inputs_Container_DSC_Test_Harness extends App {
  ...
  override def main(args: ISZ[String]): Z = {
    ...
    Example_Regulate_Subsystem_Inputs_Container_Test_wSlangCheck.genJsons(T)
