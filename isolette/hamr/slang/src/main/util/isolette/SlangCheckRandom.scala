...
@msig trait RandomLibI {
  ...
  // ============= system_tests.monitor1.Monitor_Subsystem_Inputs_Container ===================

  def get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container
  def set_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container(config: Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container): RandomLib

  def nextsystem_testsmonitor1Monitor_Subsystem_Inputs_Container(): system_tests.monitor1.Monitor_Subsystem_Inputs_Container = {
    var lowerAlarmTempWStatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var upperAlarmTempWStatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var currentTempWStatus: Isolette_Data_Model.TempWstatus_impl = nextIsolette_Data_ModelTempWstatus_impl()
    var monitor_mode: Isolette_Data_Model.Monitor_Mode.Type = nextIsolette_Data_ModelMonitor_ModeType()
    var internalFailure: Isolette_Data_Model.Failure_Flag_impl = nextIsolette_Data_ModelFailure_Flag_impl()

    var v: system_tests.monitor1.Monitor_Subsystem_Inputs_Container = system_tests.monitor1.Monitor_Subsystem_Inputs_Container(lowerAlarmTempWStatus, upperAlarmTempWStatus, currentTempWStatus, monitor_mode, internalFailure)

    if(get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container.attempts >= 0) {
     for(i <- 0 to get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container.attempts) {
        if(get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container.filter(v)) {
          return v
        }
        if (get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container.verbose) {
          println(s"Retrying for failing value: $v")
        }
        ...
        v = system_tests.monitor1.Monitor_Subsystem_Inputs_Container(lowerAlarmTempWStatus, upperAlarmTempWStatus, currentTempWStatus, monitor_mode, internalFailure)
     }
    } else {
     while(T) {
       if(get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container.filter(v)) {
  ...
  // ============= system_tests.monitor1.Monitor_Subsystem_Outputs_Container ===================

  def get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container
  def set_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container(config: Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container): RandomLib

  def nextsystem_testsmonitor1Monitor_Subsystem_Outputs_Container(): system_tests.monitor1.Monitor_Subsystem_Outputs_Container = {
    var monitor_status: Isolette_Data_Model.Status.Type = nextIsolette_Data_ModelStatusType()
    var alarm_control: Isolette_Data_Model.On_Off.Type = nextIsolette_Data_ModelOn_OffType()
    var monitor_mode: Isolette_Data_Model.Monitor_Mode.Type = nextIsolette_Data_ModelMonitor_ModeType()

    var v: system_tests.monitor1.Monitor_Subsystem_Outputs_Container = system_tests.monitor1.Monitor_Subsystem_Outputs_Container(monitor_status, alarm_control, monitor_mode)

    if(get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container.attempts >= 0) {
     for(i <- 0 to get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container.attempts) {
        if(get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container.filter(v)) {
          return v
        }
        if (get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container.verbose) {
          println(s"Retrying for failing value: $v")
        }
        monitor_status = nextIsolette_Data_ModelStatusType()
        alarm_control = nextIsolette_Data_ModelOn_OffType()
        monitor_mode = nextIsolette_Data_ModelMonitor_ModeType()
        v = system_tests.monitor1.Monitor_Subsystem_Outputs_Container(monitor_status, alarm_control, monitor_mode)
     }
    } else {
     while(T) {
       if(get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  // ============= system_tests.monitor1.Monitor_Subsystem_Inputs_Container ===================
  def alwaysTrue_system_testsmonitor1Monitor_Subsystem_Inputs_Container(v: system_tests.monitor1.Monitor_Subsystem_Inputs_Container): B = {return T}

  var config_system_testsmonitor1Monitor_Subsystem_Inputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container = Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container(100, _verbose, alwaysTrue_system_testsmonitor1Monitor_Subsystem_Inputs_Container _)

  def get_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container = {return config_system_testsmonitor1Monitor_Subsystem_Inputs_Container}

  def set_Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container(config: Config_system_testsmonitor1Monitor_Subsystem_Inputs_Container): RandomLib ={
    config_system_testsmonitor1Monitor_Subsystem_Inputs_Container = config
    return this
  }

  // ============= system_tests.monitor1.Monitor_Subsystem_Outputs_Container ===================
  def alwaysTrue_system_testsmonitor1Monitor_Subsystem_Outputs_Container(v: system_tests.monitor1.Monitor_Subsystem_Outputs_Container): B = {return T}

  var config_system_testsmonitor1Monitor_Subsystem_Outputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container = Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container(100, _verbose, alwaysTrue_system_testsmonitor1Monitor_Subsystem_Outputs_Container _)

  def get_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container: Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container = {return config_system_testsmonitor1Monitor_Subsystem_Outputs_Container}

  def set_Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container(config: Config_system_testsmonitor1Monitor_Subsystem_Outputs_Container): RandomLib ={
    config_system_testsmonitor1Monitor_Subsystem_Outputs_Container = config
    return this
  }
