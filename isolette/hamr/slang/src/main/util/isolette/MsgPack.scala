...
object MsgPack {
  ...
  object Constants {
    ...
    val system_testsrstRegulate_Subsystem_Inputs_Container: Z = 45

    val system_testsrstRegulate_Subsystem_Outputs_Container: Z = 46

    val system_testsmonitor1Monitor_Subsystem_Inputs_Container: Z = 47

    val system_testsmonitor1Monitor_Subsystem_Outputs_Container: Z = 48
