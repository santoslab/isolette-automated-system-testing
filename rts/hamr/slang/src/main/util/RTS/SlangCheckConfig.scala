...
@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_DataTypeId.Type], filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container => B) {}

@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_P(attempts: Z, verbose: B, filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_P => B) {}

@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_PS(attempts: Z, verbose: B, filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PreState_Container_PS => B) {}

@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_DataTypeId.Type], filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container => B) {}

@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_P(attempts: Z, verbose: B, filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_P => B) {}

@datatype class Config_ActuatorsActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_PS(attempts: Z, verbose: B, filter: Actuators.ActuatorsMockThread_i_actuatorsMock_actuatorsMockThread_PostState_Container_PS => B) {}
...
@datatype class Config_EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_P(attempts: Z, verbose: B, filter: EventControl.EventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_P => B) {}

@datatype class Config_EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_PS(attempts: Z, verbose: B, filter: EventControl.EventControlMockThread_i_eventControlMock_eventControlMockThread_PreState_Container_PS => B) {}

@datatype class Config_EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_DataTypeId.Type], filter: EventControl.EventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container => B) {}

@datatype class Config_EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_P(attempts: Z, verbose: B, filter: EventControl.EventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_P => B) {}

@datatype class Config_EventControlEventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_PS(attempts: Z, verbose: B, filter: EventControl.EventControlMockThread_i_eventControlMock_eventControlMockThread_PostState_Container_PS => B) {}

@datatype class Config_InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_DataTypeId.Type], filter: Instrumentation.InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container => B) {}

@datatype class Config_InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_P(attempts: Z, verbose: B, filter: Instrumentation.InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_P => B) {}

@datatype class Config_InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_PS(attempts: Z, verbose: B, filter: Instrumentation.InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PreState_Container_PS => B) {}

@datatype class Config_InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_DataTypeId.Type], filter: Instrumentation.InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container => B) {}

@datatype class Config_InstrumentationInstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_P(attempts: Z, verbose: B, filter: Instrumentation.InstrumentationMockThread_i_instrumentationMock_instrumentationMockThread_PostState_Container_P => B) {}
...
@datatype class Config_system_testsrts1Actuation_Subsystem_Inputs_Container(attempts: Z, verbose: B, filter: system_tests.rts1.Actuation_Subsystem_Inputs_Container => B) {}

@datatype class Config_system_testsrts1Actuation_Subsystem_Outputs_Container(attempts: Z, verbose: B, filter: system_tests.rts1.Actuation_Subsystem_Outputs_Container => B) {}
