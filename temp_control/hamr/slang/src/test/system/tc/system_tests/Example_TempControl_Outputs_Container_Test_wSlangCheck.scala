...
import art.Art
import tc._
import tc.system_tests.TempControl_Outputs_Container_SlangCheck.{NameProvider, TestRow}

// Do not edit this file as it will be overwritten if SystemTestArtifactGen is rerun

class Example_TempControl_Outputs_Container_Test_wSlangCheck
  extends TempControl_Outputs_Container_SlangCheck {
  ...
  def examplePreStateContainerFilter(container: TempControl_Outputs_Container): B = {
