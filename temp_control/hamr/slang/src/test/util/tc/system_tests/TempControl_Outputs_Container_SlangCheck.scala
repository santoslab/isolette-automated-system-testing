...
trait TempControl_Outputs_Container_SlangCheck
  ...
  def next(profile: TempControl_Outputs_Container_Profile): Option[TempControl_Outputs_Container] = {
    return TempControl_Outputs_Container_Profile.nextH(profile)
  }

  def freshRandomLib: RandomLib = {
    return TempControl_Outputs_Container_Util.freshRandomLib
  }

  def getProfiles: MSZ[TempControl_Outputs_Container_Profile] = {
  ...
  def getDefaultProfile: TempControl_Outputs_Container_Profile = {
    return TempControl_Outputs_Container_Profile.getDefaultProfile
  }
